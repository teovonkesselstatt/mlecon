...
###     Árboles    ###
######################
set.seed(9999) # Para que todos tengamos el mismo resultado de VC.
...
rpart.plot(arbol.Churn, type = 2, cex=0.75)
...
arbol.Churn$variable.importance # Importancia de cada covariable (feature).

importancia <- arbol.Churn$variable.importance
...
pred= predict(arbol.Churn.podado, type='class')
head(pred,3)
